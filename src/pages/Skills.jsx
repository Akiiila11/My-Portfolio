...
export default () => {
  ...
  return (
    ...
    <section id="skills" className="w-full h-full flex flex-col items-center justify-center px-4 md:px-6">
                    ...
                    >
                        {
                            data.map((skill) => (
                                <SwiperSlide
                                  key={skill.id}
                                  className="!w-[200px] !h-[230px] sm:!w-[220px] sm:!h-[250px] md:!w-[250px] md:!h-[280px] flex flex-col items-center justify-center gap-3 backdrop-blur-md bg-white rounded-xl shadow-xl hover:scale-105 hover:bg-white/70 transition-all duration-1000"
                                >
