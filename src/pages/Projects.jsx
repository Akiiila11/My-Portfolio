...
const Projects = () => {
  return (
    <section id='projects' className='w-full h-full flex flex-col items-center justify-center px-4 md:px-6 py-40 dark:bg-linear-to-r dark:from-black dark:to-black'>
      ...
      <p className='mt-3 dark:text-gray-600 text-gray-700 text-center text-sm'>The following projects demonstrate my hands-on experience with modern web technologies, including brief descriptions and tech stacks.</p>
