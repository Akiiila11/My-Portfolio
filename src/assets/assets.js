  ...
  export const projects = [
    {
      ...
      description: 'A responsive React.js Recipe Search App with dynamic search, recipe details view, and the ability to add or remove favorites using data from an server API.',
      technologies: ['React.js','JavaScript','useState','useContext','useEffect','Tailwind CSS'],
    ...
    },
    {
      ...
      img: assets.proj_2,
      name: 'My-Shop-Cart',
      description: 'A React-based shopping cart app where users can add products to the cart, view selected items, and remove them as needed.',
      technologies: ['React.js','JavaScript','useState','useEffect','Tailwind CSS'],
