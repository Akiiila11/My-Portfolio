...
const Hero = () => {
  ...
  return (
      <section id='hero' className='w-full'>
        <div className='relative h-[80vh] lg:h-screen bg-cover bg-center bg-no-repeat flex items-center justify-center text-center '>
          <img src={assets.bg_hero} className='dark:hidden' alt="" />
        </div> 
        <div className='w-full flex items-center justify-center'>
          <div className='w-full h-[80vh] lg:h-screen absolute inset-0 backdrop-blur-xl flex flex-col items-center justify-center'>
